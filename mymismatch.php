<?php
  ...
  if (mysqli_num_rows($data) != 0) {
  	...
  	//Initialize the mismatch seach results
  	$mismatch_score = 0;
  	$mismatch_user_id = -1;
  	...
  	if ($mismatch_user_id != -1) {
  		...
  		if (mysqli_num_rows($data) == 1) {
  			...
  			echo '<h4>You are mismactehd on the following ' . count($mismatch_topics) . ' topics:</h4>';
  	...
  	echo '<p>You must first <a href="questionnaire">answer the questionnaire</a> before you can be mismatched.</p>';
  }
